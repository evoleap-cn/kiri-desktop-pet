...
// Read stdin for session_id (external hook runners can pipe JSON metadata)
const chunks = [];
let sent = false;
...
// (200ms was too aggressive on slower machines)
  ...
  const req = require("http").request(
    {
      ...
      timeout: 500,  // 400ms stdin + 500ms HTTP = 900ms total budget
    },
    () => process.exit(0)
  );
